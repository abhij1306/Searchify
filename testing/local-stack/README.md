...
Ready-made, runnable implementations of the test stack specced in
[`docs/plans/v1-integrations-handoff.md`](../../docs/plans/v1-integrations-handoff.md)
(§2 reproduction, §5 browser groups B–H). Nothing here is imported by the app;
everything is test-only tooling run by hand. No real secrets anywhere — OAuth
client creds and provider tokens are literal `stub-*` dummies.
