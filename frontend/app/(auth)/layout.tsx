 ...
 * [5fr 6fr] pairs a token-driven brand panel (wordmark, eyebrow + display
 * headline, proof points, a static decorative mini stat card, footer strip)
 ...
 *
 * The single-h1 rule: the pages own the only h1 — the wordmarks here are
...
export default function AuthLayout({ children }: Readonly<{ children: ReactNode }>) {
  return (
    <div className="bg-background min-h-dvh min-[900px]:grid min-[900px]:grid-cols-[minmax(0,5fr)_minmax(0,6fr)]">
      {/* ── Brand panel (hidden below 900px) ─────────────────────────── */}
        ...
        <div className="relative flex flex-1 flex-col">
          ...
          <div className="text-muted text-2xs flex items-center justify-between font-mono tracking-[0.14em] uppercase">
            <span>
              <span
                aria-hidden="true"
                className="bg-accent mr-2 inline-block size-1 rounded-full"
              />
