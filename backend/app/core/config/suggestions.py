...
COMPETITOR_SUGGESTION_SYSTEM_PROMPT: Final = (
    ...
    "product category and competitive segment.\n"
    "Rules:\n"
    ...
    "- Match the brand's positioning closely: price tier, target audience, "
    "retail/service format, product breadth, and purchase occasion. Adjacent "
    "premium, specialist, or fast-fashion brands are not direct competitors "
    "to a value family retailer merely because both sell clothing.\n"
    "- If positioning context is limited, be conservative and prefer clear "
    "same-segment competitors over broad category neighbors.\n"
